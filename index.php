...
<input class="w3-input w3-theme-l1 w3-border-0" name="user_password" type="password" maxlength="30"></p>
<button class="w3-button w3-padding-large w3-theme-d4 w3-round w3-border-0" id="login" name="login">Log in</button></form><br>
<?php
