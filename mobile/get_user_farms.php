...
$query_farm="SELECT farm_name, farm_app_id, farm_version, farm_size_acres, farm_date_created, plot_id, internal_plot_id, plot_x, plot_y, plot_w, plot_h FROM farm, plot WHERE farm.user_id = $user_id AND plot.farm_id = farm.farm_id ORDER BY farm_name, farm_version, internal_plot_id";
